...
case that we were still in relation to it. While the flat earthers among you
would agree that this makes sense, those of us that understand the earth to be
a spinning ball of mass rotating a sun are hesitant to believe that the Ether,
thought to be independent of any one mass, was in some way linked to the motion
of the earth. This is called "Reducto Ad Absurdum" in mathematical circles; As
such, Ether is shown to be something that doesn't exist.
