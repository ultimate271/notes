...
characeters.
Step 8 is to do this for scene two, and then subsequent scenes. The only
...
Step 9 is to audit your work. Start at character 1 (marked as C.1 in the bottom
left of your character card) this is the very first person in the play. The
...
Step 9.1 (if you choose to be anal about it) is to do a similar auditing
...
Step 10 is then to fill in whatever more information on the back of each card.
