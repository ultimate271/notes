...
In computer science, there is a branch called lambda calculus. Similar to set
...
that some people think that they might doesn't mean that there aren't other
...
join them, when really they are two seperate entities.
...
these little bug fixes and features, but it's a start, and I'm not going to
delude myself into thinking that I can just write code and have it be useful.
So it's something of a stepping stone to where I want to go.
